...
enum EngineService {
    /// The engine binary nested in the shipping app: Expandr.app/Contents/MacOS/espanso.
    static var bundledEngine: URL? {
        let url = Bundle.main.bundleURL.appendingPathComponent("Contents/MacOS/espanso")
